///////To Schedule notes/////////
//Create an oscillator or sound source
//
...
gain1.gain.setValueAtTime(0.0, 2);
gain1.gain.setValueAtTime(0.5, 3);
gain1.gain.setValueAtTime(0.0, 4);
...
gain2.gain.setValueAtTime(0.0, 2.5);
gain2.gain.setValueAtTime(0.5, 3.5);
gain2.gain.setValueAtTime(0.0, 4.5);
